...
# Функция парсинга длительности из строки
def parse_duration(text: str) -> int:
    """Преобразует строку вида '5д', '10ч', '30м', '45с' или просто число (дни) в секунды."""
...
def cooldown_settings_category_keyboard():
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text="🔙 Назад", callback_data="admin_cooldown_settings")]
    ])
